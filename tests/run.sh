...
node --test tests/dashboard_view_model.test.mjs tests/dashboard_navigation.test.mjs tests/dashboard_pilotage.test.mjs tests/dashboard_format.test.mjs tests/dashboard_agents.test.mjs
